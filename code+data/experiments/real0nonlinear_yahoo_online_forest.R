### difference from real0_yahoo: use non-linear data, only run 2500 times
...
is_append <- FALSE # for debugging, set it to False

online_filename = "data/_yahoo_nonlinear_reindex_exp_80000.csv"
offline_filename = "data/_yahoo_nonlinear_reindex_obs_20000.csv"
...
output_file_prefix = 'data/result_real0nonlinear_yahoo2500_'
